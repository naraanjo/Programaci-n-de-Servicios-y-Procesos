	...
	public void Lanzar() throws Exception {
		...
		try {
			...
			for (Integer numero : listaNumeros) {
				...
				// ----- ENVIO INFO PP - PH1 -----
				try (BufferedWriter bw1 = new BufferedWriter(new OutputStreamWriter(proceso1.getOutputStream(), Charset.forName("UTF-8")))) {
				...
				try (BufferedReader br1 = new BufferedReader(new InputStreamReader(proceso1.getInputStream(), Charset.forName("UTF-8")))) {
					String linea1 = "";
				...
				// ------ CREACION PH2 -----
				ProcessBuilder pb2 = new ProcessBuilder("java", "-cp", "bin", "primo.PH2");
				pb2.redirectError(new File("src/primo/ErroresPH2.txt"));
				Process proceso2 = pb2.start();

				// ---- ENVIO INFO A PH-2 --------
				try (BufferedWriter bw2 = new BufferedWriter(new OutputStreamWriter(proceso2.getOutputStream(), Charset.forName("UTF-8")))) {
				...
				try (BufferedReader br2 = new BufferedReader(new InputStreamReader(proceso2.getInputStream(), Charset.forName("UTF-8")))) {
					String linea2 = "";
